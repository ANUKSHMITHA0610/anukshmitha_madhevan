...
export interface GenerateImageParams {
  ...
  seed?: number | null;
  lora?: string[];
  inputImage?: string; // Base64 encoded image for img2img
}
...
export class RunwareService {
  ...
  async generateImage(params: GenerateImageParams): Promise<GeneratedImage> {
    ...
    return new Promise((resolve, reject) => {
      const message = [{
        taskType: params.inputImage ? "imageInference" : "imageInference",
        taskUUID,
        ...
        steps: params.inputImage ? 20 : 4, // More steps for img2img
      ...
      if (params.inputImage) {
        message[0].inputImage = params.inputImage;
        message[0].taskType = "imageInference";
      }
